...
class GeminiChatBot:
    ...
    def display_header(self):
        ...
        info_table.add_row(
            "💬 Commands:", "/help, /clear, /save, /history, /config, /quit"
        )
    ...
    def handle_command(self, user_input):
        ...
        if command == "/help":
            ...
            if self.conversation_history:
                ...
                self.console.print(
                    "[yellow]📝 No conversation history to clear![/yellow]"
                )
            return True
    ...
    def show_available_models(self):
        ...
        models_table = Table(
            title="[bold blue]Available Gemini Models[/bold blue]", box=box.ROUNDED
        )
        ...
        models_table.add_row(
            "gemini-1.5-flash", "Fast, efficient model", "Quick responses, chat"
        )
        models_table.add_row(
            "gemini-1.5-pro", "More capable, slower", "Complex reasoning, analysis"
        )
        models_table.add_row(
            "gemini-2.0-flash-exp", "Latest experimental", "Cutting-edge features"
        )
