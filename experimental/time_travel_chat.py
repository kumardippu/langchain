    ...
    def get_future_scenarios() -> Dict[str, FuturePerspective]:
        ...
        scenarios["2050_sustainable"] = FuturePerspective(
            ...
            achievements=[
                ...
                "Most diseases curable",
                "Education fully personalized",
            ],
        )
        ...
        scenarios["2075_space"] = FuturePerspective(
            ...
            achievements=[
                "1 million people in space",
                "Aging process controlled",
                "Full brain-computer interfaces",
                "Quantum internet",
            ],
        )
        ...
        scenarios["2100_post_human"] = FuturePerspective(
            ...
            challenges=[
                "Identity and consciousness definitions",
                "Resource abundance management",
                "Galactic expansion ethics",
            ],
            achievements=[
                "Death is optional",
                "Scarcity eliminated",
                "Solar system colonized",
                "First interstellar probe returns",
            ],
        )
        ...
        scenarios["2200_galactic"] = FuturePerspective(
            ...
            achievements=[
                "50 star systems inhabited",
                "Multiple intelligent species contact",
...
class TimeTravelChat:
    ...
    def display_time_periods(self):
        ...
        historical_table = Table(
            title="📜 Historical Figures", show_header=True, header_style="bold yellow"
        )
        ...
        for i, (key, figure) in enumerate(self.historical_figures.items(), 1):
            historical_table.add_row(
                ...
                figure.period,
                (
                    figure.famous_for[:60] + "..."
                    if len(figure.famous_for) > 60
                    else figure.famous_for
                ),
            )
        ...
        for i, (key, scenario) in enumerate(self.future_scenarios.items(), 1):
            future_table.add_row(
                ...
                scenario.scenario,
                (
                    scenario.tech_level[:60] + "..."
                    if len(scenario.tech_level) > 60
                    else scenario.tech_level
                ),
            )
    ...
    def select_time_period(self):
        ...
        console.print(
            "🎯 [bold bright_cyan]Select your time-travel destination:[/bold bright_cyan]"
        )
        console.print(
            "💡 [dim]Enter H1-H6 for historical figures or F1-F4 for future scenarios[/dim]"
        )
    ...
    def display_entity_info(self):
        ...
        if self.current_mode == "historical":
            ...
            info_text.append(
                f"⭐ Famous for: {figure.famous_for}\n", style="bright_white"
            )
            info_text.append(
                f"🎭 Traits: {', '.join(figure.personality_traits)}\n",
                style="bright_blue",
            )
            info_text.append(
                f"📚 Knowledge up to: {figure.knowledge_cutoff}", style="dim"
            )
            ...
            info_text.append(
                f"🔬 Tech Level: {scenario.tech_level}\n", style="bright_cyan"
            )
            info_text.append(
                f"🏙️ Society: {scenario.society_description}\n", style="bright_white"
            )
    ...
    def chat_with_entity(self):
        ...
        if self.current_mode == "historical":
            ...
            console.print(
                f"💡 [dim]They only know about events up to {figure.knowledge_cutoff}[/dim]"
            )
            ...
            console.print(
                f"💡 [dim]They're looking back at 2024 from {scenario.year - 2024} years in the future[/dim]"
            )

        console.print(
            f"📝 [dim]Commands: /info - show details, /switch - change time period, /quit - exit[/dim]"
        )
        ...
        try:
            while True:
                ...
                user_input = Prompt.ask(
                    "🗣️  [bold bright_cyan]Your message[/bold bright_cyan]"
                )
                ...
                with Progress(
                    ...
                    if self.current_mode == "historical":
                        progress.add_task(
                            description="⏳ Consulting the historical records...",
                            total=None,
                        )
                    else:
                        progress.add_task(
                            description="🔮 Accessing future perspectives...",
                            total=None,
                        )
                ...
                self.conversation_log.append(
                    {
                        ...
                        "entity": (
                            ...
                            if self.current_mode == "historical"
                            else f"Future {self.current_entity.year}"
                        ),
            ...
            console.print(
                Panel(
                    Text.assemble(
                        ...
                        (
                            f"{len(set([log['entity'] for log in self.conversation_log]))}",
                            "bold bright_yellow",
                        ),
